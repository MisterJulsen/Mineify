...
public class PlaylistScreen extends Screen implements IPlaylistScreen {
    ...
    private Component textLoop = Component.translatable("gui.mineify.soundselection.loop");
    private Component textRandom = Component.translatable("gui.mineify.soundselection.random");
    ...
    protected void init() {
        ...
        this.availablePackList = new TransferableSoundSelectionList(this.minecraft, LIST_WIDTH, this.height - 10, Component.translatable("gui.mineify.soundselection.available"));
        this.availablePackList.setLeftPos(this.width / 2 - 4 - 200);
        this.addWidget(this.availablePackList);

        this.selectedPackList = new TransferableSoundSelectionList(this.minecraft, LIST_WIDTH, this.height - 10, Component.translatable("gui.mineify.soundselection.playlist"));
        this.selectedPackList.setLeftPos(this.width / 2 + 4);
        this.addWidget(this.selectedPackList);

        this.searchAvailable = new EditBox(this.font, this.width / 2 - 4 - 200, 32, 200, 20, Component.translatable("gui.mineify.soundselection.search"));
        ...
        this.searchPlaylist = new EditBox(this.font, this.width / 2 + 4, 32, 200, 20, Component.translatable("gui.mineify.soundselection.search"));
